...
fn test_scene() -> HittableList {
    ...
    let ground_material = Arc::new(Lambertian::new(Color::new(0.7, 0.3, 0.6)));
    world.add(Box::new(Sphere::new(
        Point3::new(0.0, -1000.0, 0.0),
        1000.0,
        ground_material,
    ...
    let material4 = Arc::new(Dielectric::new(1.0/1.5));
    world.add(Box::new(Sphere::new(
        Point3::new(-2.0, 1.0, -1.0),
        0.8,
        material4,
...
fn main() {
    ...
    let lookfrom = Point3::new(0.0, 1.5, 5.0);
    let lookat = Point3::new(0.0, 0.0, -1.0);
    let vup = Point3::new(0.0, 1.4, 0.0);
